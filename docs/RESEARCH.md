...
- **This is the source for the data the save only references.** `school-locations.ts` (hand-written city/state for 138 schools) could be replaced by reading the CITY table, and `TROP`/`STNM` are the bowl-trophy and stadium-name equivalents.

...
- **Scouting Reports.** Search the class by attribute. *Receivers with 92+ speed. Quarterbacks with 94+ throw power. Tackles over 6'6" and 300 pounds.* The attribute menu is split into Physical ratings (measurables, speed, strength, agility and the rest of the body ratings) and the Positional skills scouted for the position you pick. Stack as many thresholds as you like, and each becomes its own sortable column. Every hit carries the same + control as the boards, so a find goes straight onto your board.
